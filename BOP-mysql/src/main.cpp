...
const string strMessageMagic = "beonpush Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    { 
		int64_t nSubsidy = 100000000 * COIN; // 100mill premine
	...
	{
        int64_t nSubsidy = 15 * COIN; //15 reward for 10 years.
...
int64_t GetProofOfStakeReward(int64_t nCoinAge, int64_t nFees)
{
    ...
    if(pindexBest->nMoneySupply <= 200000000)
	{
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "beonpush", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "BOP's Crypto currency to be launched ahead of it's remitance app";
        CTransaction txNew;
        txNew.nTime = 1486224087;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1486224087;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 2744441;
		if(fTestNet)
        {
			block.nTime    = 1486224087;
            block.nNonce   = 2744441;
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x6552098ba107c273a7e20bad77fe897337c19df0222cdb250cbe6dd433534925"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0x2a, 0xca, 0x42, 0xd1 };
